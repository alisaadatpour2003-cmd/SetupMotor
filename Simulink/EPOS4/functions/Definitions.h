...
//Advanced Functions
    ...
    Configuration_DllExport BOOL __stdcall VCS_GetSsiAbsEncoderParameterEx2(HANDLE KeyHandle, WORD NodeId, WORD* pDataRate, WORD* pNbOfSpecialDataBitsLeading, WORD* pNbOfMultiTurnDataBits, WORD* pNbOfMultiTurnPositionBits, WORD* pNbOfSingleTurnDataBits, WORD* pNbOfSingleTurnPositionBits, WORD* pNbOfSpecialDataBitsTrailing, BOOL* pInvertedPolarity, WORD* pTimeout, WORD* pPowerupTime, BOOL* pCheckFrame, BOOL* pReferenceReset, DWORD* pErrorCode);
